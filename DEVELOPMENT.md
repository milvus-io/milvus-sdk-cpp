...
- `./cmake_build/examples/sdk_iterator_query`: example to show the usage of search iterator.
- `./cmake_build/examples/sdk_iterator_search`: example to show the usage of query iterator.
