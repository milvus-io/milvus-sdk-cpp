...
class HybridSearchRequest : public DQLRequestBase {
 public:
     ...
     */
    HybridSearchRequest&
    WithOutputFieldNames(std::set<std::string>&& output_field_names);
     ...
     */
    void
    SetGroupByField(const std::string& group_by_field);

    /**
     * @brief Set group by field value.
     */
    HybridSearchRequest&
    WithGroupByField(const std::string& group_by_field);
