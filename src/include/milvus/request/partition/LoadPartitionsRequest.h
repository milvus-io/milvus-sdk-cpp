...
class LoadPartitionsRequest {
 public:
     ...
     */
    void
    SetPartitionNames(const std::vector<std::string>& partition_names);

    /**
     * @brief Set new name of the partitions.
     */
    LoadPartitionsRequest&
    WithPartitionNames(const std::vector<std::string>& partition_names);
     ...
     */
    void
    SetLoadFields(const std::vector<std::string>& load_fields);

    /**
     * @brief Set load fields.
     */
    LoadPartitionsRequest&
    WithLoadFields(const std::vector<std::string>& load_fields);
     ...
     */
    void
    SetTargetResourceGroups(const std::vector<std::string>& target_resource_groups);

    /**
     * @brief Set target resource groups.
     */
    LoadPartitionsRequest&
    WithTargetResourceGroups(const std::vector<std::string>& target_resource_groups);
 ...
 private:
    ...
    bool refresh_{false};
    std::vector<std::string> load_feilds_;
    bool skip_dynamic_field_{false};
    std::vector<std::string> target_resource_groups_;
};
