...
#include "request/rbac/RoleRequest.h"
...
#include "response/utility/GetCompactionResponse.h"
...
class MilvusClientV2 {
 public:
     ...
     */
    virtual Status
    SearchIterator(const SearchIteratorRequest& request, SearchIteratorPtr& response) = 0;
     ...
     */
    virtual Status
    QueryIterator(const QueryIteratorRequest& request, QueryIteratorPtr& response) = 0;
