...
class MilvusClientV2Impl : public MilvusClientV2 {
 public:
    ...
    static std::shared_ptr<MilvusClientV2Impl>
    Create();
    ...
    Status
    SearchIterator(const SearchIteratorRequest& request, SearchIteratorPtr& response) final;
    ...
    Status
    QueryIterator(const QueryIteratorRequest& request, QueryIteratorPtr& response) final;
