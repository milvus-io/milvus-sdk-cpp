...
// repeat this in other files (e.g. SearchIteratorV2Impl.cpp): multiple explicit instantiation
// definitions are an ODR violation in general, and unity builds surface it as a hard error.
...
template class MILVUS_SDK_API SearchIteratorImpl<SearchIteratorArguments>;
template class MILVUS_SDK_API SearchIteratorImpl<SearchIteratorRequest>;
