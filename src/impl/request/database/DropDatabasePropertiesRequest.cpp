...
void
DropDatabasePropertiesRequest::SetPropertyKeys(std::unordered_set<std::string>&& keys) {
    property_keys_ = std::move(keys);
}

DropDatabasePropertiesRequest&
DropDatabasePropertiesRequest::WithPropertyKeys(std::unordered_set<std::string>&& keys) {
