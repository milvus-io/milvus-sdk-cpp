...
void
ReleasePartitionsRequest::SetPartitionNames(const std::vector<std::string>& partition_names) {
    partition_names_ = partition_names;
}

ReleasePartitionsRequest&
ReleasePartitionsRequest::WithPartitionNames(const std::vector<std::string>& partition_names) {
