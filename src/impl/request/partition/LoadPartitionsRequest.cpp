...
void
LoadPartitionsRequest::SetPartitionNames(const std::vector<std::string>& partition_names) {
    partition_names_ = partition_names;
}

LoadPartitionsRequest&
LoadPartitionsRequest::WithPartitionNames(const std::vector<std::string>& partition_names) {
...
void
LoadPartitionsRequest::SetLoadFields(const std::vector<std::string>& load_fields) {
    load_feilds_ = load_fields;
}

LoadPartitionsRequest&
LoadPartitionsRequest::WithLoadFields(const std::vector<std::string>& load_fields) {
...
void
LoadPartitionsRequest::SetTargetResourceGroups(const std::vector<std::string>& target_resource_groups) {
    target_resource_groups_ = target_resource_groups;
}

LoadPartitionsRequest&
LoadPartitionsRequest::WithTargetResourceGroups(const std::vector<std::string>& target_resource_groups) {
