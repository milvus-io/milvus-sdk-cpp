...
HybridSearchRequest&
HybridSearchRequest::WithOutputFieldNames(std::set<std::string>&& output_field_names) {
    // Implementation here
    return *this;
}
...
void
HybridSearchRequest::SetGroupByField(const std::string& group_by_field) {
    SetExtraStr(extra_params_, "group_by_field", group_by_field);
}

HybridSearchRequest&
HybridSearchRequest::WithGroupByField(const std::string& group_by_field) {
