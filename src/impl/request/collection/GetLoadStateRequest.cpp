...
void
GetLoadStateRequest::SetPartitionNames(std::vector<std::string>&& partition_names) {
    partition_names_ = std::move(partition_names);
}

GetLoadStateRequest&
GetLoadStateRequest::WithPartitionNames(std::vector<std::string>&& partition_names) {
    partition_names_ = std::move(partition_names);
    return *this;
}
