...
void
LoadCollectionRequest::SetLoadFields(const std::vector<std::string>& load_fields) {
    load_feilds_ = load_fields;
}

LoadCollectionRequest&
LoadCollectionRequest::WithLoadFields(const std::vector<std::string>& load_fields) {
...
void
LoadCollectionRequest::SetTargetResourceGroups(const std::vector<std::string>& target_resource_groups) {
    target_resource_groups_ = target_resource_groups;
}

LoadCollectionRequest&
LoadCollectionRequest::WithTargetResourceGroups(const std::vector<std::string>& target_resource_groups) {
