...
CreateProtoArrayField(const FieldDataSchema& data_schema, proto::schema::FieldData& proto_field) {
    ...
    bool nullable = schema ? schema->IsNullable() : false;
    ...
    switch (field_type) {
        ...
        case DataType::BOOL:
            scalar->set_allocated_bool_data(
                CreateProtoScalars<BoolFieldData, proto::schema::BoolArray>(field, field_data, nullable));
            break;
        case DataType::INT8:
            scalar->set_allocated_int_data(
                CreateProtoScalars<Int8FieldData, proto::schema::IntArray>(field, field_data, nullable));
            break;
        case DataType::INT16:
            scalar->set_allocated_int_data(
                CreateProtoScalars<Int16FieldData, proto::schema::IntArray>(field, field_data, nullable));
            break;
        case DataType::INT32:
            scalar->set_allocated_int_data(
                CreateProtoScalars<Int32FieldData, proto::schema::IntArray>(field, field_data, nullable));
            break;
        case DataType::INT64:
            scalar->set_allocated_long_data(
                CreateProtoScalars<Int64FieldData, proto::schema::LongArray>(field, field_data, nullable));
            break;
        case DataType::FLOAT:
            scalar->set_allocated_float_data(
                CreateProtoScalars<FloatFieldData, proto::schema::FloatArray>(field, field_data, nullable));
            break;
        case DataType::DOUBLE:
            scalar->set_allocated_double_data(
                CreateProtoScalars<DoubleFieldData, proto::schema::DoubleArray>(field, field_data, nullable));
            break;
        case DataType::VARCHAR:
            scalar->set_allocated_string_data(
                CreateProtoScalars<VarCharFieldData, proto::schema::StringArray>(field, field_data, nullable));
            break;
        case DataType::JSON:
            scalar->set_allocated_json_data(
                CreateProtoScalars<JSONFieldData, proto::schema::JSONArray>(field, field_data, nullable));
            break;
        case DataType::ARRAY:
