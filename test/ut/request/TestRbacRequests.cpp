...
TEST_F(UpdateUserRequestTest, GettersAndSetters) {
    milvus::UpdateUserRequest req;
...
class AlterRoleRequestTest : public ::testing::Test {};

TEST_F(AlterRoleRequestTest, GettersAndSetters) {
    milvus::AlterRoleRequest req;
