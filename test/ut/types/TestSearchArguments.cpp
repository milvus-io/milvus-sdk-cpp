...
TEST_F(SearchArgumentsTest, DatabaseName) {
    milvus::SearchArguments arguments;
...
TEST_F(SearchArgumentsTest, FilterTemplates) {
    milvus::SearchArguments arguments;
    ...
    EXPECT_EQ(arguments.FilterTemplates().size(), 1);
    EXPECT_EQ(arguments.FilterTemplates().at("age"), 42);
}

TEST_F(SearchArgumentsTest, ConsistencyLevel) {
    milvus::SearchArguments arguments;
...
TEST_F(SearchArgumentsTest, IgnoreGrowing) {
    milvus::SearchArguments arguments;
...
TEST_F(SearchArgumentsTest, GuaranteeTimestamp) {
    milvus::SearchArguments arguments;
...
TEST_F(SearchArgumentsTest, SetGroupByField) {
    milvus::SearchArguments arguments;
    EXPECT_EQ(arguments.GroupByField(), "");

    auto status = arguments.SetGroupByField("category");
    EXPECT_TRUE(status.IsOk());
    EXPECT_EQ(arguments.GroupByField(), "category");
}

TEST_F(SearchArgumentsTest, SetGroupSize) {
    milvus::SearchArguments arguments;

    auto status = arguments.SetGroupSize(5);
    EXPECT_TRUE(status.IsOk());
    EXPECT_EQ(arguments.GroupSize(), 5);
}

TEST_F(SearchArgumentsTest, SetStrictGroupSize) {
    milvus::SearchArguments arguments;

    auto status = arguments.SetStrictGroupSize(true);
    EXPECT_TRUE(status.IsOk());
    EXPECT_TRUE(arguments.StrictGroupSize());
}

TEST_F(SearchArgumentsTest, SetRoundDecimal) {
    milvus::SearchArguments arguments;

    auto status = arguments.SetRoundDecimal(3);
    EXPECT_TRUE(status.IsOk());
