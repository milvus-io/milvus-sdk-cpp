...
main(int argc, char* argv[]) {
    ...
    const std::string collection_name = "TEST_CPP_DYNAMIC_FIELD";
    ...
    s_arguments.SetFilter("dynamic in [4, 6, 8]");  // filter on dynamic field
    s_arguments.SetLimit(10);
    s_arguments.AddOutputField(field_text);
    s_arguments.AddOutputField("dynamic");
