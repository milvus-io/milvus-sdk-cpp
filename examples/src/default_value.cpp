...
main(int argc, char* argv[]) {
    ...
    const std::string collection_name = "TEST_CPP_NULLABLE_FIELD";
...

    {
        ...
        q_arguments.SetFilter(field_name + " is null");  // query entity whose name is null value
        ...
        std::cout << "Query with filter: " << q_arguments.Filter() << " in " << partition_1 << std::endl;
...

    {
        ...
        s_arguments.SetFilter(field_age + " is not null");  // search entitiies whose age is not null value
        s_arguments.SetLimit(10);
        s_arguments.AddOutputField(field_name);
        s_arguments.AddOutputField(field_age);
        s_arguments.AddOutputField(field_array);
        ...
        std::cout << "Search with filter: " << s_arguments.Filter() << std::endl;
