...
namespace {
const char* const collection_name = "CPP_V2_ITERATOR_SEARCH";
...
void
iterateCollection(milvus::MilvusClientV2Ptr& client, int64_t batch, int64_t limit, const std::string& filter) {
    std::cout << "=====================================================" << std::endl;
