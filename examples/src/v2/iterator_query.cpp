...
main(int argc, char* argv[]) {
    ...
    const std::string collection_name = "CPP_V2_ITERATOR_QUERY";
    ...
    // create index
    milvus::IndexParam index_vector(field_face, "", milvus::IndexType::AUTOINDEX, milvus::MetricType::L2);
    ...
    uint64_t row_count = 0;
    {
        ...
        row_count = response.Results().GetRowCount();
    }
